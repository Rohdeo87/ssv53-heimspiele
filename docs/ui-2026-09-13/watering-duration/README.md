...
Veröffentlichungsstand und abschließende Testergebnisse: siehe `release-status.json`. Nach ausdrücklicher Freigabe wurden Backend und Appack veröffentlicht. Das installierte Manifest stimmt mit dem geprüften Paket überein; 75 Manifest-Dateien wurden durch den Host geprüft, alle 16 Functions sind vorhanden und drei reguläre Steuerungszyklen mit der neuen Version wurden nachgewiesen. Keine Journal-Schreibfehler wurden im betrachteten Zeitraum protokolliert. Die gespeicherte Appack-Vorlage und die öffentlich ausgelieferten Statistikfunktionen stimmen mit der vorbereiteten Quelle überein (`appack-public-proof.json`).

Die produktive Statistikabfrage wurde mit ausdrücklich gesetztem Acht-Tage-Abfragebereich ausgeführt: 9.247 vorhandene Zeilen wurden mit dem veröffentlichten Code ausgewertet. Die zuletzt abgeschlossene Folge ergibt 160 Minuten ohne Schätzkennzeichnung; ältere unvollständige Nachweise bleiben als Schätzung erkennbar. Das ist eine erneute Auswertung von Geräteprotokollen, kein neu ausgelöster Gerätetest und kein separat erfasster nativer App-Bildschirm. Eine zuerst mit dem CLI-Standardzeitraum von einer Stunde ausgeführte Kontrollabfrage wurde verworfen; der Produktivcode setzt seinen Acht-Tage-Zeitraum bereits ausdrücklich.

Reviewfähige Veröffentlichung: [PR #89](https://github.com/Rohdeo87/ssv53-heimspiele/pull/89), gestapelt auf dem bestehenden Karten-Branch. Es wurde kein Merge in den Hauptbranch vorgenommen.
