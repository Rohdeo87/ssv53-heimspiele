...
Dies ist ein vorbereiteter Ablauf, keine Produktionsfreigabe. Aktuell wurden
...
## Konkreter nächster Freigabeschritt

Zuerst [PR #46](https://github.com/Rohdeo87/ssv53-heimspiele/pull/46) am exakten
Kopf `efe932cbaf5186f050847a29347566782e891c20` prüfen und den **Import-Merge
mit kontrolliertem anschließendem Quellenlauf** freigeben. Der
...
Vor deren Deployment sind Rollenwirkung, State-Migration, installierte
Versionskette und native Gerätepläne zu klären. Eine Freigabe des Importfixes
genehmigt keinen Mäher-/Bewässerungspilot und keine Veröffentlichung der
Appack-Templates. Der neue Optimierer bleibt ohne Produktionsadapter und ohne
separaten beaufsichtigten Pilotauftrag vollständig befehlsfrei.
