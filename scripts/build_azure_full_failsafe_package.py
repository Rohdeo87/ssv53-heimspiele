...
def build_package(repository_root: Path, output_path: Path) -> dict[str, object]:
    ...
    manifest = {
        ...
        "manual_sessions_implemented": True,
        "manual_sessions_default_enabled": False,
        "manual_control_contract_version": 3,
        "onsite_dock_confirmation_implemented": True,
        "onsite_dock_confirmation_default_enabled": False,
        "onsite_dock_confirmation_contract_version": 4,
        "onsite_dock_proof_loss_stop_implemented": True,
        "onsite_dock_live_validation_required": True,
        "manual_water_choice_per_conflict_required": True,
        ...
        "coordination_execution_code_present": True,
        "coordination_execution_default_enabled": False,
        "coordination_execution_requires_approved_need": True,
        "coordination_execution_requires_additional_confirmation": True,
        "coordination_execution_pilot_reservation_limit": 24,
        ...
        "fresh_park_event_policy_exception": "IRRIGATION_CONFIRMED_PARK_HOLD_ENABLED=true and valid owned HOME proof",
        "confirmed_home_park_hold_available": True,
        "confirmed_home_park_hold_default_enabled": False,
        "confirmed_home_park_hold_max_read_gap_seconds": 90,
        "confirmed_home_park_hold_requires_external_start_after_water_stop": True,
