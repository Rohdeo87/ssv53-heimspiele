...
const viewFunctions = [
  ...
  "isMowerPaused", "irrigationScheduleChangePending", "mowerActions", "effectiveMowerActions",
  "simpleStatus", "chargingEnd", "nextStartInfo", "nextMowerStart", "actionProgressText",
